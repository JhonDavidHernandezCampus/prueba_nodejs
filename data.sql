...
CREATE TABLE bodegas(
    id BIGINT(20) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    nombre VARCHAR(255),
    id_responsabe BIGINT(20)UNSIGNED,
    estado TINYINT(4),
    created_by BIGINT(20) UNSIGNED,
    update_by BIGINT(20) UNSIGNED,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP,
    CONSTRAINT fk_id_users FOREIGN KEY (id_responsabe) REFERENCES users(id),
    CONSTRAINT fk_create_by_bodegas FOREIGN KEY (created_by) REFERENCES users(id),
    CONSTRAINT fk_update_by_bodegas FOREIGN KEY (update_by) REFERENCES users(id)
);
...
CREATE TABLE productos(
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP,
    CONSTRAINT fk_create_by_productos  FOREIGN KEY (created_by) REFERENCES users(id),
    CONSTRAINT fk_update_by_productos  FOREIGN KEY (update_by) REFERENCES users(id)
);
...
CREATE TABLE inventarios(
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP,
    CONSTRAINT fk_id_bodega_inventarios FOREIGN KEY (id_bodega) REFERENCES bodegas(id),   
    CONSTRAINT fk_id_producto_inventarios FOREIGN KEY (id_producto) REFERENCES productos(id),
    CONSTRAINT fk_create_by_inventarios  FOREIGN KEY (created_by) REFERENCES users(id),
    CONSTRAINT fk_update_by_inventarios  FOREIGN KEY (update_by) REFERENCES users(id)
);
CREATE TABLE historiales(
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP,
    CONSTRAINT fk_id_bodega_origen_historiales FOREIGN KEY (id_bodega_origen) REFERENCES bodegas(id),
    CONSTRAINT fk_id_bodega_destino_historiales FOREIGN KEY (id_bodega_destino) REFERENCES bodegas(id),
    CONSTRAINT fk_id_inventario_historiales FOREIGN KEY (id_inventario) REFERENCES inventarios(id),
    CONSTRAINT fk_create_by_historiales FOREIGN KEY (created_by) REFERENCES users(id),
    CONSTRAINT fk_update_by_historiales  FOREIGN KEY (update_by) REFERENCES users(id)

);
ALTER TABLE bodegas
RENAME COLUMN id_responsabe TO id_responsable;
